...
Connection = (function() {
  function Connection(dataSite, sodaOpts) {
    ...
    this.networker = function(opts, data) {
      var client, hostPlusProxyIfSet, _ref1,
        _this = this;
      hostPlusProxyIfSet = this.dataSite;
      if ((((_ref1 = this.sodaOpts) != null ? _ref1.sodaProxy : void 0) != null)) {
        hostPlusProxyIfSet = "" + this.sodaOpts.sodaProxy + "/" + this.dataSite;
      }
...
Query = (function() {
  ...
  Query.prototype.getURL = function() {
    var hostPlusProxyIfSet, opts, query, _ref;
    opts = this.getOpts();
    query = toQuerystring(opts.query);
    hostPlusProxyIfSet = this.consumer.dataSite;
    if ((((_ref = this.consumer.sodaOpts) != null ? _ref.sodaProxy : void 0) != null)) {
      hostPlusProxyIfSet = "" + this.consumer.sodaOpts.sodaProxy + "/" + this.consumer.dataSite;
    }
    return ("https://" + hostPlusProxyIfSet + opts.path) + (query ? "?" + query : "");
  };
